  ...
  return (
    <Modal>
      <div className='w-full min-w-[300px] sm:min-w-[600px] p-3'>
        <h2 className='text-center font-bold uppercase text-xl'>Updating field</h2>
        <p className='font-medium text-red-dark text-center uppercase'>Field name: {reportTypeField?.field.name}</p>
