    ...
    <Modal>
      <div className='w-[400px] pb-6'>
        ...
        <div className={`${loading ? 'block' : 'hidden'}`}>
          <div role="status" className='grid place-items-center mt-4'>
            <svg aria-hidden="true" className="w-10 h-10 mr-2 text-gray-300 animate-spin fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
